                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @if (Config::get('menu::editprofile'))
                            <li><a href="{{ URL::to(Config::get('menu::editprofileurl')) }}"><span
                                        class="glyphicon glyphicon-tasks"></span> Editar Perfil</a></li>
                            <li role="presentation" class="divider"></li>
                        @endif

                        @if (Config::get('menu::viewhelp') || Config::get('menu::viewabout'))
                            @if (Config::get('menu::viewhelp'))
                                <li><a href="{{ URL::to(Config::get('menu::viewhelpurl')) }}"><span
                                            class="glyphicon glyphicon-question-sign"></span> Ayuda</a></li>
                            @endif
                        ...
                        <li><a href="{{ URL::to('logout') }}"><span class="glyphicon glyphicon-lock"></span> Cerrar
                                sesi&oacute;n</a></li>
                    </ul>
                </li>
            </ul>
